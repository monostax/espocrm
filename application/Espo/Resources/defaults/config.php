...
return [
    ...
    'outboundEmailFromName' => 'Monostax CRM',
    ...
    'activitiesEntityList' => ['Meeting', 'Call', 'Task'],
    'historyEntityList' => ['Meeting', 'Call', 'Email', 'Task'],
    ...
    'phoneNumberPreferredCountryList' => ['br'],
