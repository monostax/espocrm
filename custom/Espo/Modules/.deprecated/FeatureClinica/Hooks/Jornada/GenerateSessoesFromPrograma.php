    ...
    private function createSessoes(Entity $jornada, Entity $programa, array $teamsIds): void
    {
        ...
        foreach ($itens as $item) {
            ...
            for ($i = 0; $i < $quantidade; $i++) {
                ...
                // Propagate dosagemInjetavel from Jornada to Sessao
                $dosagemInjetavel = $jornada->get('dosagemInjetavel');
                if ($dosagemInjetavel && $dosagemInjetavel > 0) {
                    $sessaoData['dosagemAplicada'] = $dosagemInjetavel;
                }
