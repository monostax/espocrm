...
This module contains all customizations for the Clínica (Medical Clinic) system. It provides patient management, medical consultations, doctor records, AI agent integration, and call tracking functionality.
...
`custom/Espo/Modules/Clinica/`

All PHP namespaces were updated from `Espo\Custom\Controllers` to `Espo\Modules\Clinica\Controllers`.
