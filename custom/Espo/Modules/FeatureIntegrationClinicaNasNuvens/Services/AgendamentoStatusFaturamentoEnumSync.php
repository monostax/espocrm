...
class AgendamentoStatusFaturamentoEnumSync
{
    private const ENTITY_TYPE = 'FeatureIntegrationClinicaNasNuvensAgendamento';
    private const FIELD = 'statusFaturamento';
    ...
    private function persistOption(string $key, string $label): void
    {
        ...
        $this->log->info(
            "FeatureIntegrationClinicaNasNuvens: added agendamento.statusFaturamento enum option '{$key}' with label '{$label}'."
        );
    }
