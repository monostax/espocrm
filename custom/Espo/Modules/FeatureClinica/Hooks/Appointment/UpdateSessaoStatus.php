...
/**
 * Updates Sessao status to "Agendada" when an Appointment is linked to a Sessao.
 */
class UpdateSessaoStatus
{
    ...
    public function beforeSave(Entity $entity, array $options): void
    {
        ...
        if ($sessao->get('status') === 'Pendente') {
            $sessao->set('status', 'Agendada');
            $sessao->set('appointmentId', $entity->getId());
