...
- **Validation hooks**: Follow [ValidateCRM.php](components/crm/source/custom/Espo/Modules/FeatureClinica/Hooks/Profissional/ValidateCRM.php) (traditional hook style with `$order` property and `beforeSave` method)
