...
/**
 * Rebuild action to seed the Google Meet OAuth provider.
 ...
 */
class SeedOAuthProviderGoogleMeet implements RebuildAction
{
    private const PROVIDER_ID = 'msx_gmeet_01';
    private const PROVIDER_NAME = 'Google Meet';
    ...
    {
        $this->log->info('FeatureIntegrationGoogleMeet: Seeding OAuth provider for Google Meet...');
        ...
        if ($existing) {
            ...
            $this->log->info('FeatureIntegrationGoogleMeet: OAuth provider "' . self::PROVIDER_NAME . '" updated.');
        } else {
            $this->createProvider();
            $this->log->info('FeatureIntegrationGoogleMeet: OAuth provider "' . self::PROVIDER_NAME . '" created.');
        }
    }
