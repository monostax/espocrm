...
namespace Espo\Modules\ClinicaMedica\Hooks\User;
...
class AddDefaultCalendarViews implements AfterSave
{
    ...
    public function afterSave(Entity $entity, SaveOptions $options): void
    {
        ...
        $calendarViews = [
            [
                'id' => 'view-cm-medicos',
                'name' => 'Calendário Médicos',
                'mode' => 'agendaWeek',
                'teamIdList' => [$this->prepareId('clinica-medica-team', $toHash)],
                'teamNames' => (object)[$this->prepareId('clinica-medica-team', $toHash) => 'Clínica Médica'],
            ],
            [
                'id' => 'view-cm-all',
                ...
                'mode' => 'month',
                'teamIdList' => [
                    $this->prepareId('clinica-medica-team', $toHash),
                    $this->prepareId('enfermagem-team', $toHash),
                    $this->prepareId('administrativo-team', $toHash),
                ],
                'teamNames' => (object)[
                    $this->prepareId('clinica-medica-team', $toHash) => 'Clínica Médica',
