...
class SeedCalendarViews implements RebuildAction
{
    ...
    public function process(): void
    {
        ...
        $calendarViews = [
            // Calendário dos Profissionais - Month view
            [
                'id' => 'cm-profissional-month',
                'name' => 'Calendário dos Profissionais (Mês)',
                'mode' => 'month',
                'teamIdList' => [$this->prepareId('cm-profissional', $toHash)],
                'teamNames' => (object)[$this->prepareId('cm-profissional', $toHash) => 'Clínica - Profissionais'],
            ],
            // Calendário dos Profissionais - Week view
            [
                'id' => 'cm-profissional-week',
                'name' => 'Calendário dos Profissionais (Semana)',
                'mode' => 'agendaWeek',
                'teamIdList' => [$this->prepareId('cm-profissional', $toHash)],
                'teamNames' => (object)[$this->prepareId('cm-profissional', $toHash) => 'Clínica - Profissionais'],
            ],
            // Calendário dos Profissionais - Day view
            [
                'id' => 'cm-profissional-day',
                'name' => 'Calendário dos Profissionais (Dia)',
                'mode' => 'agendaDay',
                'teamIdList' => [$this->prepareId('cm-profissional', $toHash)],
                'teamNames' => (object)[$this->prepareId('cm-profissional', $toHash) => 'Clínica - Profissionais'],
            ],
            ...
            [
                ...
                'mode' => 'month',
                'teamIdList' => [
                    $this->prepareId('cm-profissional', $toHash),
                    $this->prepareId('cm-administrativo', $toHash),
                    $this->prepareId('cm-pacientes', $toHash),
                    $this->prepareId('cm-gestores', $toHash),
                ],
                'teamNames' => (object)[
                    $this->prepareId('cm-profissional', $toHash) => 'Clínica - Profissionais',
                    $this->prepareId('cm-administrativo', $toHash) => 'Clínica - Administrativo',
                    $this->prepareId('cm-pacientes', $toHash) => 'Clínica - Pacientes',
                    $this->prepareId('cm-gestores', $toHash) => 'Clínica - Gestores',
                ],
            ],
