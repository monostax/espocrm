...
/**
 * SMTP handler for Microsoft 365 via OAuthAccount (XOAUTH2).
 *
 ...
 */
class Microsoft365SmtpHandler implements Handler
{
    ...
    public function handle(SmtpParams $params, ?string $id): SmtpParams
    {
        ...
        if ($entity === null) {
            throw new RuntimeException("Microsoft365SmtpHandler: account '$id' not found.");
        }
        ...
        if (!$oAuthAccountId) {
            $this->log->warning(
                "Microsoft365SmtpHandler: account '$id' has no oAuthAccountId; using stored credentials."
            );
        ...
        try {
            ...
            $this->log->error(
                "Microsoft365SmtpHandler: failed to obtain token for OAuthAccount '$oAuthAccountId' " .
        ...
        if (!$emailAddress) {
            throw new RuntimeException("Microsoft365SmtpHandler: no email address on account '$id'.");
        }
