...
/**
 * Cascades tenant from the parent ChatwootAccount onto this run.
 *
 * Denormalizes ChatwootAccount.tenant onto ChatwootAiAgentRun so reports
 * and per-tenant filters can index/group directly on chatwoot_ai_agent_run
 * without joining through the account table. Mirrors the existing
 * CascadeTeamsFromAccount pattern (order=1).
 *
