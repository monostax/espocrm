...
use Espo\Modules\Chatwoot\Services\OpportunityGroupSummary as Summary;
...
class OpportunityGroupSummary
{
    ...
    public function getActionSummary(Request $request, Response $response): object
    {
        ...
        $response->setHeader('Server-Timing', 'groupSummary;dur=' . round((hrtime(true) - $started) / 1e6, 2));
