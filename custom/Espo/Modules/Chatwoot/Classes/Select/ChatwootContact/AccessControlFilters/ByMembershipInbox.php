...
namespace Espo\Modules\Chatwoot\Classes\Select\ChatwootContact\AccessControlFilters;
...
class ByMembershipInbox implements Filter
{
    ...
    public function apply(QueryBuilder $queryBuilder): void
    {
        ...
        $queryBuilder
            ->distinct()
            ->leftJoin('contactInboxes', 'contactInboxAccess')
            ->where(['contactInboxAccess.inboxId' => $allowedInboxIdList]);
    }
}
