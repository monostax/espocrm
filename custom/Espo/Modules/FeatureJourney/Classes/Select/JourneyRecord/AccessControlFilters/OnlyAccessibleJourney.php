...
namespace Espo\Modules\FeatureJourney\Classes\Select\JourneyRecord\AccessControlFilters;
...
/**
 * Constrain JourneyRecord list/search to records whose parent Journey
 * is on one of the user's teams (mirrors AccessChecker parent delegation).
 */
