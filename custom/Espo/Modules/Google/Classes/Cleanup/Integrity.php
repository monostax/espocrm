...
namespace Espo\Modules\Google\Classes\Cleanup;
...
class Integrity implements Cleanup
{
    ...
    private string $hash = 'c85d552557673ffb6d597148484aea56';
    ...
    public function __construct(
        ...
        $this->name = base64_decode('R29vZ2xlIEludGVncmF0aW9u');
        $this->file = base64_decode('Y3VzdG9tL0VzcG8vTW9kdWxlcy9Hb29nbGUvQ2xhc3Nlcy9BcHAvSm9iUnVubmVyLnBocA==');
        $this->class = base64_decode('RXNwb1xNb2R1bGVzXEdvb2dsZVxDbGFzc2VzXEFwcFxKb2JSdW5uZXI=');
