define("global:views/activities/list", ["exports", "views/list", "multi-collection"], function (_exports, _list, _multiCollection) {
  "use strict";
  ...
  class ActivitiesListView extends _list.default {
    template = "list";
    scope = "Activities";
    name = "Activities";
    ...
    setup() {
      ...
      this.searchFields = {
        ...
        status: {
          type: "enum",
          options: ["Planned", "Held", "Not Held", "Not Started", "Started", "Completed", "Canceled", "Deferred"]
        },
        dateStart: {
          type: "datetime"
        },
    ...
    setupCreateButtons() {
      ...
      this.scopeList.forEach(entityType => {
        ...
        this.buttonList.push({
          ...
          style: "default",
          iconClass: this.getMetadata().get(["clientDefs", entityType, "iconClass"]),
          data: {
            scope: entityType
          }
        });
    ...
    actionSwitchToKanban() {
      this.getRouter().navigate("#Activities/kanban", {
        trigger: true
      });
    }
    actionSwitchToList() {
      this.getRouter().navigate("#Activities", {
        trigger: true
      });
    }
    ...
    getHeader() {
      return this.buildHeaderHtml([$("<span>").text(this.translate("Activities"))]);
    }
    updatePageTitle() {
      this.setPageTitle(this.translate("Activities"));
    }
    getSearchDefaultData() {
      return this.getMetadata().get("clientDefs.Activities.defaultSearchData") || {};
    }
    getRecordViewName() {
      if (this.type === "kanban") {
        return this.getMetadata().get("clientDefs.Activities.recordViews.kanban") || "global:views/activities/record/kanban";
      }
      return this.getMetadata().get("clientDefs.Activities.recordViews.list") || "global:views/activities/record/list";
    }
  }
  var _default = _exports.default = ActivitiesListView;
});
