define("global:views/activities/record/list", ["exports", "views/record/list"], function (_exports, _list) {
  "use strict";
  ...
  class ActivitiesRecordListView extends _list.default {
    type = "list";
    checkboxes = false;
  ...
  var _default = _exports.default = ActivitiesRecordListView;
});
