define("global:controllers/activities", ["exports", "controller"], function (_exports, _controller) {
  "use strict";
  ...
  class ActivitiesController extends _controller.default {
    ...
    // Default action (called when navigating to #Activities)
    actionIndex() {
      this.actionList();
    }
    ...
    // List view action
    actionList() {
      this.main("global:views/activities/list", {
        scope: "Activities",
        type: "list"
      });
    }
    ...
    // For backward compatibility with existing activities panel
