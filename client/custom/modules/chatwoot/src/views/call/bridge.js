...
/**
 * Bridge view for the Call dashboard app tab.
 *
...
class CallBridgeView extends View {
    ...
    _requestContext() {
        try {
            ...
            console.error(
                "CallBridge: Failed to request context from parent:",
                e,
            );
        }
    }
    ...
    async _lookupAndNavigate(chatwootConversationId, chatwootAccountId) {
        ...
        try {
            ...
            // Navigate to the related Call list for this conversation
            this.getRouter().navigate(
                `#ChatwootConversation/related/${entityId}/calls`,
                { trigger: true },
            );
        } catch (e) {
            console.error(
                "CallBridge: Failed to look up conversation:",
                e,
            );
    ...
    async _postCount(entityId) {
        try {
            ...
            console.error("CallBridge: Failed to post count:", e);
        }
    }
}

export default CallBridgeView;
