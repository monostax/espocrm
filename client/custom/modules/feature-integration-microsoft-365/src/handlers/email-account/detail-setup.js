...
/**
 * EmailAccount detail/edit setup for Microsoft 365 OAuth.
 *
 * When a Microsoft 365 OAuthAccount is selected in the UI (before save),
 * pre-fill Office 365 IMAP/SMTP hosts so the form matches what the
 * server-side hook will persist. Does not overwrite non-M365 hosts.
 *
 * Only applies defaults after confirming the linked account is microsoft-365
 * (the field is shared with Gmail).
 */
define("feature-integration-microsoft-365:handlers/email-account/detail-setup", [], () => {
