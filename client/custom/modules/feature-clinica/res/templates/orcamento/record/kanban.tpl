...
.kanban-header-stats .value {
    font-weight: 600;
    color: #111827;
}

/* Color variations for header based on status style */
            ...
            <div class="kanban-column group-header{{#if style}} group-header-{{style}}{{else}} group-header-default{{/if}}" data-name="{{name}}">
                <div class="kanban-header-card">
                    ...
                    <div class="kanban-header-stats">
                        <span>{{translate 'Total Value' scope='Orcamento'}}</span>
                        <span class="value kanban-group-value">{{valueSumFormatted}}</span>
                    </div>
                </div>
                    ...
                    <div class="group-column-list-visual" data-name="{{name}}">
                        ...
                        {{else}}
                            <div class="kanban-empty-placeholder">
                                {{translate 'Drop here' scope='Orcamento'}}
                            </div>
                        {{/if}}
                    </div>
                    {{#if hasShowMore}}
