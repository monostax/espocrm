 ...
 *
 * @module custom/modules/clinica-medica/views/calendar/resource-calendar
 */
...
class ResourceCalendarView extends View {
    ...
    template = 'clinica:calendar/resource-calendar'
    ...
    events = {
        ...
        /** @this ResourceCalendarView */
        'click button[data-action="showResourceOptions"]': function () {
    ...
    fetchEvents(from, to, callback) {
        ...
        // Build user ID list for fetching
        const userIdList = this.userList.map(u => u.id);
    ...
    async actionShowResourceOptions() {
        const viewName = 'clinica:views/calendar/modals/resource-options';
